        ...
        <div className={containerClasses}>
            <div className=" flex flex-col">
                ...
                <div className="flex flex-col  sm:flex-row sm:justify-between sm:items-start gap-4 mb-4 md:mb-6">
                    ...
                    <div className={`px-3 sm:px-4 py-1 sm:py-2 rounded-full text-xs sm:text-sm font-medium border-2 self-start sm:self-center ${company?.companyType === 'Admin'
                            ? isDark
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
                            ...
                            <div className="space-y-3 md:space-y-4">
                                <div className="flex items-start xs:items-center space-x-3">
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <p className={`text-xs ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>companyname</p>
                                        <p className={`font-medium text-sm md:text-base truncate ${isDark ? 'text-white' : 'text-gray-900'}`}>
                        ...
                        <div className="space-y-3 md:space-y-4">
                            <div className="flex items-start space-x-3">
                                ...
                                <div className="min-w-0 flex-1">
                                    ...
                                    <p className={`text-xs ${isDark ? 'text-gray-400' : 'text-gray-500'} truncate`}>
                                        {company?.createdAt ? formatDate(company.createdAt) : 'Unknown'}
                                    </p>
                                    <p className={`text-xs ${isDark ? 'text-blue-400' : 'text-blue-600'}`}>
                                        {company?.createdAt ? getAccountAge(company.createdAt) + ' ago' : ''}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div className="min-w-0 flex-1">
                                    ...
                                    <p className={`text-xs ${isDark ? 'text-gray-400' : 'text-gray-500'} truncate`}>
                                        {company?.updatedAt ? formatDate(company.updatedAt) : 'Unknown'}
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                        <div className="text-center">
                            <div className={`text-lg sm:text-xl md:text-2xl font-bold ${isDark ? 'text-blue-400' : 'text-blue-600'}`}>
                                {company?.createdAt ? getAccountAge(company.createdAt).split(' ')[0] : '0'}
                            </div>
                            <div className={`text-xs ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                                {company?.createdAt ? getAccountAge(company.createdAt).split(' ')[1] : 'days'} old
                            </div>
                        </div>
                        <div className="text-center">
                        ...
                        <div className="text-center">
                            <div className={`text-lg sm:text-xl md:text-2xl font-bold ${isDark ? 'text-purple-400' : 'text-purple-600'}`}>
                                {company?._id ? company._id.slice(-4).toUpperCase() : 'N/A'}
                            </div>
                            <div className={`text-xs ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                                company ID
                            </div>
