...
export default function Navbar() {
    ...
    return (
        <section className={`sticky top-0  z-50 transition-all duration-100 ${
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <div className="relative">
                                    <button
                                        ...
                                        className={`flex items-center space-x-3 p-2 rounded-2xl transition-all duration-200 hover:scale-105 ${
                                            theme === 'dark'
                                    ...
                                    {showUserMenu && (
                                        <div className={`absolute right-0 mt-2 w-64 rounded-2xl shadow-2xl border backdrop-blur-lg z-50 ${
                                            ...
                                            <div className="p-2">
                                                ...
                                                <a href="/applications" className={`flex items-center space-x-3 w-full p-3 rounded-lg transition-colors ${
                                                    theme === 'dark'
                                                        ? 'text-gray-300 hover:bg-gray-700/50 hover:text-white'
                                                        : 'text-gray-600 hover:bg-gray-100/50 hover:text-gray-900'
                                                }`}>
