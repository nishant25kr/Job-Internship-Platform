  ...
  return (
    <div className={`${cardClasses} relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 p-6 max-w-sm border group`}>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <div className={`p-3 rounded-xl ${
          theme === 'dark' ? 'bg-gradient-to-r from-emerald-900/20 to-blue-900/20 border border-emerald-700/30' : 'bg-gradient-to-r from-emerald-50 to-blue-50 border border-emerald-200'
        }`}>
          <div className={`text-xs font-medium mb-1 ${
      ...
      <div className="flex gap-3 mt-6">
        ...
        <button className={`px-4 py-2 rounded-lg border transition-all duration-200 ${
          theme === 'dark'
